...
public class PaymentProcessorImpl implements PaymentProcessor {
    ...
    @Autowired
    public PaymentProcessorImpl(RestTemplate restTemplate, SessionTokenManager sessionTokenManager, CsvHelper csvHelper) {
    ...
    public void submitOutgoingPayment(List<PaymentRequest> paymentRequests) {
        ...
        paymentRequests.forEach(paymentRequest -> {
            ...
            try {
                ...
                if (httpClientErrorException.getStatusCode() == HttpStatus.FORBIDDEN && System.currentTimeMillis() - SessionTokenManagerImpl.getTokenReceivedTime() >= tokenTimeOut) {
